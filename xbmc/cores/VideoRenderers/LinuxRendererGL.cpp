...
void CLinuxRendererGL::FlipPage(int source)
{
  ...
  CLog::Log(LOGDEBUG, "CLinuxRendererGL::FlipPage m_iCurrentRenderBuffer: %i m_buffers[m_iCurrentRenderBuffer].flipindex: %i", m_iCurrentRenderBuffer, m_buffers[m_iCurrentRenderBuffer].flipindex);
...
{
  // return new free buffer index if successfully flipped, -1 otherwisw
  if (!m_bValidated)
    return -1;
